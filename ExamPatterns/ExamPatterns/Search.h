...
public:
	...
	bool searchPriority(const Priority& prior) const;
...
public:
	ISearchCommand(list<std::shared_ptr<TaskList>>* l, TaskListFacade* f) : List{ l }, manager{ f } {}
...
public:
	SearchConcrete(list<std::shared_ptr<TaskList>>* l, TaskListFacade* f) : ISearchCommand(l, f) {}
...
public:
	SearchTag(list<std::shared_ptr<TaskList>>* l, TaskListFacade* f) : ISearchCommand(l, f) {}
...
public:
	SearchDeadline(list<std::shared_ptr<TaskList>>* l, TaskListFacade* f) : ISearchCommand(l, f) {}
...
public:
	SearchDate(list<std::shared_ptr<TaskList>>* l, TaskListFacade* f) : ISearchCommand(l, f) {}
...
public:
	SearchPriority(list<std::shared_ptr<TaskList>>* l, TaskListFacade* f) : ISearchCommand(l, f) {}
